...
View = (function() {
  ...
  View.prototype.criteriaTab = function() {
    var _, bubble, clonedRow, column, columnSize, counter, criteriaGroup, criteriaText, d, f, i, k, len, marginSize, maxY, nodeGroup, numberOfColumns, numberOfRows, ref, ref1, row, rowSize, v;
    criteriaGroup = {};
    ref = Criteria.hashMap;
    for (k in ref) {
      _ = ref[k];
      if (criteriaGroup[k] == null) {
        criteriaGroup[k] = [];
      }
      ref1 = this.data;
