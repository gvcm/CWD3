...
Circle = (function() {
  ...
  Circle.prototype.build = function(parent) {
    return this.element = parent.append('circle').attr('r', this.radius).attr('fill', this.fill).attr('stroke-width', 0);
  };
...
Group = (function() {
  function Group(selected, data) {
    ...
    this.element = this.nodes.enter().append('g').attr('transform', this.transform).attr('data-toggle', 'popover').attr('title', this.title).attr('data-content', this.dataContent).attr('href', this.link).attr('data-index', this.index).attr('data-placement', this.placement);
  }
  ...
  Group.prototype.index = function(data, index) {
    return index;
  };
...
Hierarchy = (function() {
  ...
  Hierarchy.prototype.nodes = function() {
    var group, groupKey, groups, i, k, len, ref, row;
    groups = {};
    ref = this.data;
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      groups[groupKey]['children'].push({
        name: row[this.nameAttr],
        value: row[this.valueAttr]
      });
    }
...
View = (function() {
  ...
  View.prototype.render = function(data) {
    ...
    pack = d3.layout.pack().size([this.width, this.height]);
...
table = new Table('data.csv', function() {
  var nodes;
  nodes = new Hierarchy(table).group('group').name('title').value('weight').nodes();
  view.render(nodes);
  ...
  $('g').hover((function() {
    ...
    return $circle.attr('stroke-width', 3);
  }), (function() {
    var $circle;
    $circle = $(this).find('circle');
    $circle.attr('stroke', 'transparent');
    return $circle.attr('stroke-width', 0);
  }));
