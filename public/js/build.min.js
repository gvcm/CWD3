...
Circle = (function() {
  ...
  Circle.prototype.build = function(parent) {
    this.element = parent.append('circle').filter(function(data) {
  ...
  Circle.prototype.show = function() {
    return this.element.transition().duration(3000).attr('r', this.radius);
  };
...
Group = (function() {
  ...
  Group.prototype.append = function(child) {
    return child.build(this.selection);
  };

  Group.prototype.charge = function(data, index) {
    return -(data.total + 1) * 20;
  };
  ...
  Group.prototype.all = function(width, height) {
    ...
    tick = (function(_this) {
      return function(e) {
        ...
        return _this.transform(function(data, index) {
      ...
      return function(e) {
        if (_this.callbacks['forceEnd'] != null) {
          _this.callbacks['forceEnd']();
        }
        return spec.transition().duration(500).attr('transform', function() {
...
Label = (function() {
  ...
  Label.prototype.build = function(parent) {
    this.element = parent.append('text').attr('opacity', 0).attr('text-anchor', 'middle').attr('font-size', this.fontSize).attr('fill', this.color);
    this.element.append('tspan').text(this.short);
    this.element.append('tspan').attr('x', 0).attr('dy', this.lineHeight).text(this.scoreN);
    return this;
  };

  Label.prototype.show = function() {
    return this.element.transition().duration(1000).attr('opacity', 1);
  };
...
Text = (function() {
  function Text(parent) {
    this.element = parent.append('text').attr('font-weight', 'bold').text('');
    this;
  }

  Text.prototype.translate = function(x, y) {
    return this.element.attr('transform', "translate(" + x + "," + y + ")");
  };

  Text.prototype.hide = function() {
    return this.element.attr('opacity', 0);
  };
...
View = (function() {
  function View(selector, data) {
    ...
    this.group = new Group(this.selection.selectAll('.node').data(data).enter());
    circle = this.group.append(new Circle());
    label = this.group.append(new Label());
    circle.show();
    label.show();
  ...
  View.prototype.scrollLock = function(lock) {
    return $('body').css('overflow', (lock ? 'hidden' : 'scroll'));
  };
