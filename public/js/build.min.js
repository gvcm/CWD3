...
Group = (function() {
  ...
  Group.prototype.cluster = function(width, height) {
    var end, tick;
    tick = (function(_this) {
      return function(e) {
        if (e.alpha < 0.03) {
...
View = (function() {
  ...
  View.prototype.allTab = function() {
    ...
    circle.show();
    label.show();
    return group.cluster(this.width, this.height).on('forceEnd', (function(_this) {
      return function() {
        var b;
        b = group.boundary();
  ...
  View.prototype.categoryTab = function() {
    var circle, group, label, nodes, pack;
    nodes = new Hierarchy(this.data).group('group').name('title').nodes();
    pack = d3.layout.pack().sort(null).size([this.width, this.height]);
    group = new Group(this.element.selectAll('.node').data(pack.nodes(nodes)).enter());
    circle = group.append(new Circle());
    label = group.append(new Label());
    this.center();
    this.scrollLock(true);
