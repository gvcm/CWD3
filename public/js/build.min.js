...
Group = (function() {
  ...
  Group.prototype.clusterize = function(width, height) {
    var end, tick;
    tick = (function(_this) {
      return function(e) {
        if (e.alpha < 0.04) {
  ...
  Group.prototype.columnize = function(width, height) {
...
View = (function() {
  ...
  View.prototype.allTab = function() {
    ...
    circle.show();
    label.show();
    return group.clusterize(this.width, this.height).on('forceEnd', (function(_this) {
      return function() {
        var b;
        b = group.boundary();
  ...
  View.prototype.categoryTab = function() {
    ...
    circle.show();
    label.show();
    return group.columnize(this.width, this.height);
  };
  ...
  View.prototype.popularityTab = function() {
    return console.log('TODO popularity');
  };
