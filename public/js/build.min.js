...
Group = (function() {
  ...
  Group.prototype.all = function(width, height) {
...
View = (function() {
  function View(selector, data) {
    ...
    new Circle(this.group.selection);
    new Label(this.group.selection);
  ...
  View.prototype.allTab = function() {
    var total;
    total = new Text(this.selection);
    this.center();
    this.scrollLock(true);
    return this.group.all(this.width, this.height).on('forceEnd', (function(_this) {
      return function() {
        var b;
