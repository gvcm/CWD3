...
View = (function() {
  ...
  View.prototype.criteriaTab = function() {
    var _, bubble, clonedRow, column, columnSize, counter, criteriaGroup, d, f, i, k, len, marginSize, maxY, nodeGroup, numberOfColumns, numberOfRows, ref, ref1, row, rowSize, v;
    criteriaGroup = {};
    ref = Criteria.hashMap;
    for (k in ref) {
      _ = ref[k];
    ...
    counter = 0;
    marginSize = 50;
    numberOfColumns = Math.ceil((this.width - (2 * marginSize)) / 500);
    columnSize = this.width / numberOfColumns;
    numberOfRows = Math.ceil(this.height / 400);
