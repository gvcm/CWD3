...
View = (function() {
  function View(selector, data) {
    ...
    group = new Group(this.selection.selectAll('g').data(data).enter());
  ...
  View.prototype.defaultTab = function() {
    ...
    return group.byDefault(this.width, this.height).on('forceEnd', (function(_this) {
      return function() {
        var b;
        b = group.boundary();
  ...
  View.prototype.categoryTab = function() {
    ...
    Label.show();
    group = Group.getInstance();
    return group.byCategory(this.width, this.height);
  };
  ...
  View.prototype.popularityTab = function() {
    var circle, group, label;
    group = new Group(this.selection.selectAll('.node').data(this.data).enter());
    ...
    circle.show();
    label.show();
    return group.byPopularity(this.width, this.height);
  };
