...
Circle = (function() {
  ...
  Circle.backgroundPallete = d3.scale.ordinal().domain(['CW', 'T', 'L', 'F2', 'F1', 'Z', 'C', 'D']).range(['#d3372c', '#2767b3', '#85898f', '#e89e78', '#3f9657', '#b3c841', '#efb052', '#5d3b5a']);
...
Text = (function() {
  ...
  Text.prototype.build = function(parent) {
    this.element = parent.append('text').attr('opacity', 0).attr('text-anchor', 'middle').attr('font-size', this.fontSize);
