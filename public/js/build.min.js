...
Group = (function() {
  ...
  Group.hide = function() {
    return Group._instance.hide();
  };

  Group.prototype.mouseover = function(x) {
  ...
  Group.prototype.mouseout = function(x) {
  ...
  Group.prototype.placement = function(data, index) {
    if (data.group === 'SPEC') {
      return 'left';
    } else {
      return 'right';
  ...
  Group.prototype.title = function(data, index) {
    if (data.group !== 'SPEC') {
      return data.title;
    }
  };

  Group.prototype.click = function(data) {
  ...
  Group.prototype.dataContent = function(data, index) {
    if ((data.total != null) && (data.score != null) && (data.group != null) && (data.description != null)) {
      return "<table> <tr><td style=\"text-align:right\"><strong>Total:</strong></td><td>&nbsp;&nbsp;&nbsp;" + data.total + "</td></tr> <tr><td style=\"text-align:right\"><strong>Scores 1–5:</strong></td><td>&nbsp;&nbsp;&nbsp;" + (data.score.join(', ')) + "</td></tr> <tr><td style=\"text-align:right\"><strong>Group:</strong></td><td>&nbsp;&nbsp;&nbsp;" + data.group + "</td></tr> <tr><td colspan=\"2\">" + data.description + "</td></tr> </table>";
    } else if (data.title != null) {
      return data.title;
    }
  };

  Group.prototype.transform = function(func) {
    return this.selection.attr('transform', func);
  };

  Group.prototype.charge = function(data, index) {
    return -(data.total + 1) * 25;
  };

  Group.prototype.byDefault = function(width, height) {
  ...
  Group.prototype.boundary = function() {
    var data, x, y;
  ...
  Group.categories = ['SPEC', 'CW', 'T', 'L', 'F2', 'F1', 'Z', 'C', 'D'];

  Group.columns = function(width) {
    var step;
    step = width / 10.0;
    return d3.scale.ordinal().domain(Group.categories).range(d3.range(step, step * 10, step));
  };

  Group.prototype.byCategory = function(width, height) {
    var category, columns, i, len, posy, ref, text;
    posy = {};
    columns = Group.columns(width);
    ref = Group.categories;
  ...
  Group.prototype.byPopularity = function(width, height) {
    var category, columns, i, len, posy, ref, text;
    posy = {};
    columns = Group.columns(width);
    ref = Group.categories;
...
View = (function() {
  function View(selector, data) {
    ...
    this.group = new Group(this.selection.selectAll('g').data(data).enter());
