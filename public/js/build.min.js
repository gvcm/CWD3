...
Circle = (function() {
  ...
  Circle.prototype.build = function(element) {
    return this.element = element.append('circle').attr('r', this.radius).attr('fill', this.fill).attr('stroke-width', 0);
  };

  Circle.prototype.radius = function(data) {
    return this.constructor.radiusScale(data.weight);
  };
...
Text = (function() {
  ...
  Text.prototype.build = function(element) {
    return this.element = element.append('text').attr('dx', 0).attr('dy', 5).attr('text-anchor', 'middle').text(this.text);
  };
...
View = (function() {
  function View(selector) {
    ...
    this.element = d3.select(selector).append('svg').attr('width', this.container.width()).attr('height', 500);
  }
