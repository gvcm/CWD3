...
Group = (function() {
  function Group(selected, data) {
    ...
    this.element = this.nodes.enter().append('g').attr('data-toggle', 'popover').attr('title', this.title).attr('data-content', this.dataContent).attr('transform', this.transform).attr('href', this.link);
  }
  ...
  Group.prototype.dataContent = function(data) {
  ...
  Group.prototype.transform = function(data) {
    var x, y;
    x = Math.random() * 1000;
    y = Math.random() * 1000;
