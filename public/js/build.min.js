...
Circle = (function() {
  ...
  Circle.prototype.build = function(parent) {
    this.element = parent.append('circle').attr('r', 0).attr('fill', this.fill).attr('stroke-width', 0);
    return this;
  };

  Circle.prototype.radius = function(data) {
    return Circle.radiusScale(data.weight);
  };
  ...
  Circle.radiusScale = d3.scale.sqrt().domain([0, 100]).range([5, 5 + (Math.sqrt(100 / Math.PI) * 10)]);
...
Group = (function() {
  ...
  Group.prototype.build = function(parent) {
    this.element = parent.append('g').attr('data-toggle', 'popover').attr('title', this.title).attr('data-content', this.dataContent).attr('data-placement', this.placement).on('mouseover', this.mouseover).on('mouseout', this.mouseout).on('click', this.click);
    this.callbacks = {};
    this.force = null;
    return this;
  };
...
Label = (function() {
  ...
  Label.prototype.build = function(parent) {
    ...
    this.element.append('tspan').attr('x', 0).attr('dy', this.lineHeight).text(this.weight);
    return this;
  };
  ...
  Label.prototype.weight = function(data, index) {
    if ((data.weight != null) && data.weight > 0 && index < Label.shortLabels.length) {
      return data.weight + "%";
    }
  };
  ...
  Label.prototype.lineHeight = function(data, index) {
    if ((data.weight != null) && data.weight > 0) {
      return Label.fontSizeScale(data.weight) * 12;
    } else {
      return 0;
    }
  };
  ...
  Label.prototype.fontSize = function(data, index) {
    if ((data.weight != null) && data.weight > 0) {
      return Label.fontSizeScale(data.weight) * 8;
    } else {
      return 0;
    }
  };
...
Row = (function() {
  function Row(record) {
    var i, num, score, str;
    this.weight = parseInt(record.scoreN, 10);
    this.score = [];
...
Text = (function() {
  ...
  Text.prototype.build = function(parent) {
...
View = (function() {
  View.prototype.setupCanvas = function(selector) {
    this.container = $(selector);
    this.container.height($(window).height() - this.container.position().top);
    this.width = this.container.width();
    this.height = this.container.height() * 2;
    return this.element = d3.select(selector).append('svg').attr('width', this.width).attr('height', this.height);
  };

  View.prototype.setupNodes = function(data) {
    return this.nodes = this.element.selectAll('.node').data(data).enter();
  };

  View.prototype.append = function(child) {
    return child.build(this.nodes);
  };

  View.prototype.setupElements = function() {
    this.group = this.append(new Group());
    this.circle = this.group.append(new Circle());
    return this.label = this.group.append(new Label());
  };
  ...
  View.prototype.tabs = function() {
    return {
      all: (function(_this) {
        return function() {
          var total;
          total = _this.append(new Text());
          _this.center();
          _this.scrollLock(true);
          _this.circle.show();
          _this.label.show();
          return _this.group.cluster(_this.width, _this.height).on('forceEnd', function() {
            var b;
      ...
      criteria: (function(_this) {
        return function() {
          return console.log('TODO criteria');
        };
      })(this),
      popularity: (function(_this) {
        return function() {
