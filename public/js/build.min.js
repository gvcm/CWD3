...
Bubble = (function() {
  function Bubble(nodes, bubbleClass) {
    ...
    this.selection = nodes.append('g').attr('class', bubbleClass).attr('data-toggle', 'popover').attr('title', this.title).attr('data-content', this.dataContent).attr('data-placement', this.placement).on('mouseover', this.mouseover).on('mouseout', this.mouseout).on('click', this.click);
    this.callbacks = {};
    this.force = null;
...
View = (function() {
  ...
  View.getSelection = function() {
    return View._instance.selection;
  };
...
table = new Table('data.csv', function() {
  ...
  return $('[data-view]').click(function() {
