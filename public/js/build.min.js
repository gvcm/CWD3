...
Circle = (function() {
  ...
  Circle.prototype.build = function(parent) {
    return this.element = parent.append('circle').attr('r', 0).attr('fill', this.fill).attr('stroke-width', 0);
  };
...
Group = (function() {
  ...
  function Group(selected, data) {
    this.nodes = selected.data(data);
    this.element = this.nodes.enter().append('g').attr('data-toggle', 'popover').attr('title', this.title).attr('data-content', this.dataContent).attr('data-placement', this.placement).on('mouseover', this.mouseover).on('mouseout', this.mouseout).on('click', this.click);
    this.callbacks = {};
    this.force = null;
  }
...
Label = (function() {
  ...
  Label.prototype.build = function(parent) {
    ...
    return this.element.append('tspan').attr('x', 0).attr('dy', this.lineHeight).text(this.weight);
  };
...
View = (function() {
  ...
  View.prototype.scrollLock = function(lock) {
    ...
    if (lock) {
      ...
      return body.css('overflow-x', 'hidden').css('overflow-y', 'scroll');
    }
  };

  View.prototype.render = function(data) {
    var circle, group, label, total;
    group = new Group(this.element.selectAll('.node'), data);
    circle = new Circle();
    label = new Label();
    total = new Text(this.element);
    group.append(circle);
    group.append(label);
    window.scrollTo(0, this.height / 4);
