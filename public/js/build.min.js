...
Bubble = (function() {
  function Bubble(nodes) {
    this.selection = nodes.append('g').attr('data-toggle', 'popover').attr('title', this.title).attr('data-content', this.dataContent).attr('data-placement', this.placement).on('mouseover', this.mouseover).on('mouseout', this.mouseout).on('click', this.click);
    this.callbacks = {};
    this.force = null;
...
View = (function() {
  ...
  View.prototype.criteriaTab = function() {
    var _, criteriaGroup, k, ref, results, row;
    criteriaGroup = {};
    ref = Criteria.hashMap;
    results = [];
    for (k in ref) {
      ...
      results.push((function() {
        ...
        for (i = 0, len = ref1.length; i < len; i++) {
          ...
          if (indexOf.call(row.criteriaKeys, k) >= 0) {
            results1.push(criteriaGroup[k].push(row));
          } else {
