...
Bubble = (function() {
  function Bubble(nodes) {
    ...
    Bubble._instance = this;
  }

  Bubble.getInstance = function() {
  ...
  Bubble.hide = function() {
    return Bubble._instance.hide();
  };

  Bubble.prototype.mouseover = function(x) {
    var circle, group, groupNode;
  ...
  Bubble.prototype.mouseout = function(x) {
    var circle, group, groupNode, parentNode;
    group = d3.select(this);
    groupNode = group.node();
...
View = (function() {
  function View(selector, data) {
    ...
    this.group = new Bubble(this.selection.selectAll('g').data(data).enter());
  ...
  View.prototype.render = function(tab) {
    ...
    d3.selectAll('g').attr('transform', function(data) {
      var rx, ry, theta;
  ...
  View.prototype.defaultTab = function() {
    ...
    return this.group.byDefault(this.width, this.height).on('forceEnd', (function(_this) {
      return function() {
        var b;
        b = _this.group.boundary();
        total.translate(((b.x1 + b.x2) / 2.0) - 15, b.y2 + 50);
        total.text("TOTAL=" + (_this.group.total()));
  ...
  View.prototype.categoryTab = function() {
    this.top();
    this.scrollLock(true);
    this.group.byCategory(this.width, this.height);
  ...
  View.prototype.criteriaTab = function() {
    return console.log('TODO criteria');
  };
