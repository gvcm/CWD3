  ...
  Group.prototype.all = function(width, height) {
    ...
    tick = (function(_this) {
      ...
      return function(e) {
        ...
        spec = _this.selection.filter(function(data) {
    ...
    this.force = d3.layout.force().nodes(nodes.data()).size([(width / 12) * 10, height]).gravity(0.1).charge(this.charge).on('tick', tick).on('end', end).start();
